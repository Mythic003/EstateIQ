    ...
    <div className="flex min-h-screen">
      ...
      >
        ...
        <div className="flex flex-col justify-center px-12 relative z-10">
          <h1 className="text-4xl font-bold text-white mb-6 drop-shadow-lg">Join EstateIQ Today</h1>
          <p className="text-lg text-white drop-shadow-lg">Create your account and start managing your real estate portfolio with ease.</p>
        </div>
      </div>
